...
struct ReviewPayload: Codable, Identifiable {
    let id: String
    let kind: String
    let rangeMode: String
    ...
    let feedback: ReviewFeedbackStatePayload?
...
struct ReviewFeedbackStatePayload: Codable {
    let selectedTypes: [String]
    let customNote: String?
    let customNoteUpdatedAt: String?
}

struct ReviewContentPayload: Codable, Equatable {
    let title: String?
    let subtitle: String?
...
struct ReviewKeywordPayload: Codable, Identifiable, Equatable {
    let label: String
    let note: String
...
struct ReviewThemePayload: Codable, Identifiable, Equatable {
    let title: String
    let body: String
...
struct ReviewEmotionalReflectionPayload: Codable, Equatable {
    let tone: String
    let body: String
}

struct ReviewProgressPayload: Codable, Equatable {
    let progress: [String]
    let openLoops: [String]
}

struct ReviewRhythmPayload: Codable, Equatable {
    let body: String
    let observations: [String]
}

struct ReviewNotableMomentPayload: Codable, Identifiable, Equatable {
    let title: String
    let note: String
