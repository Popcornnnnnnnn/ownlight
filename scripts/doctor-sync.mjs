...
function checkLocalDatabaseSignals() {
  ...
  const recentRejected = sqliteInt(databasePath, "SELECT COUNT(*) FROM sync_operations WHERE rejected_at IS NOT NULL AND rejected_at >= (unixepoch('now', '-24 hours') * 1000);");
